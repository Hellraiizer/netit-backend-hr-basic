...
<html>
    ...
    <body>
        <div id="company-header" class="webcompany-header">
           <h1 class="logo-company">Register your company</h1>
        </div>
            
        <div class="wrapper-company">
              <form method="POST" name="company-registration">
              <label for="country">Country</label>     
              <select id="country" name="country" class="country-control">
              <span class="explain">(Where the company is registered ?)</span>  
                ...
                <p class="questions">What is your company/organisation:</p>
                <input type="radio" name="government" value="1">Public
                <br>
                <input type="radio" name="government" value="2">Private
                <br>
                
                
                <p class="questions">What is your company ID:</p>
                <input class="form-input2" type="text" size="30" maxlength="255" placeholder="Company ID">
                
                <p class="questions">Company name:</p>
                <input class="form-input2" type="text" size="30" maxlength="255" placeholder="Company name">
                
                <p class="questions">Company adress:</p>
                <input class="form-input2" type="textarea" size="50" maxlength="255" placeholder="Company address">
                
                
                <p class="questions">Company site:</p>
                <input class="form-input2" type="text" size="40" maxlength="255" placeholder="Company site">     

          
                
                <label for="sector">Business Sector:</label>
                 <select id="sector" name="sector" class="sector-control">
...
<option value="Writing/Editing">Writing/Editing</option>     
 ...
 <p class="questions">Please insert your credentials:</p>
 <input class="form-input2" type="text" placeholder="First Name" name="First Name">
             <br>
             <input class="form-input2" type="text" placeholder="Last Name" name="Last Name">
             <br>
             <input class="form-input2" type="text" placeholder="Company E-mail" name="Company Email">
             <br>
             <input class="form-input2" type="text" placeholder="Position" name="Position">
             
             <p class="questions">Please insert your site credentials:</p>
             <br>
             <input class="form-input2" type="text" placeholder="Username" name="Username">
             <br>
             <input class="form-input2" type="text" placeholder="Personal E-mail" name="Personal Email">
             <br>
             <input class="form-input2" type="password" placeholder="Password" name="Password">
             <br>
             <input class="form-input2" type="password" placeholder="Repeat password" name="Repeat password">
             <br>
             
             <input class="button2" type="submit" name="post_submit">
